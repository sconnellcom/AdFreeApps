...
class ScrollFixApp {
    constructor() {
        ...
        this.beforeScrollSayings = [
            ...
            "Feeling the urge? Break it here.",
            "One scroll, then back to life.",
            "Interrupt the pattern. Scroll once.",
            "Quick hit, then get going.",
            "Break the cycle. Start here.",
            "Their algorithms can't have you.",
            "This is your intervention scroll.",
            "Redirect the impulse. Scroll here.",
            "Stop the habit loop right here.",
            "Your time is too valuable for endless feeds.",
            "Choose purpose over passive scrolling.",
            "Dopamine hit without the guilt trip.",
            "The scroll that reminds you to stop scrolling.",
            "Circuit breaker for your scroll addiction.",
            "Here to help you break free.",
            "One swipe, then get back out there.",
            "This isn't a destination, it's a detour.",
            "Scrolling won't solve it. Action will.",
            "Quick reminder: you have goals.",
            "Life's happening. Don't miss it scrolling.",
            "Snap out of it. Scroll here, then go.",
            "Your future self will thank you.",
            "The urge is real, but so is your purpose.",
            "Break the trance. Scroll once.",
            "Attention hijacked? Take it back here.",
            "Real life > fake feeds.",
            "Stop doom-scrolling. Start doing.",
            "You're better than this impulse.",
            "Wake-up call in scroll form.",
            "Time to choose: scroll or goals?"
        ];
        ...
        this.afterScrollSayings = [
            ...
            "Urge interrupted. Now move forward.",
            "Circuit broken. Keep going!",
            "Habit disrupted. Stay strong!",
            "That's enough. Time to create.",
            "Reminder received. Goals await.",
            "Pattern interrupted. Choose wisely.",
            "Scroll over. Purpose calls.",
            "Good. Now go be awesome.",
            "Reset successful. Time's ticking.",
            "Impulse handled. Back to reality.",
            "Done here. Your life needs you.",
            "That's all. Nothing more to see.",
            "Quick break over. Action time!",
            "Urge satisfied. Dreams await.",
            "Snap back complete. Go do it!",
            "Reminder served. Now execute.",
            "Wake-up call delivered. Rise up!",
            "Pause complete. Time to act.",
            "That's your dose. Now create.",
            "Detour finished. Back on track!",
            "Intervention complete. Stay focused.",
            "Pattern broken. Keep breaking it.",
            "There. Now go change the world.",
            "Alert delivered. Purpose over pleasure.",
            "Good scroll. Better life awaits.",
            "Done. Your goals won't achieve themselves.",
            "Reset. Refocus. Resume.",
            "Moment passed. Make it count.",
            "That's all you needed. Go live."
        ];
