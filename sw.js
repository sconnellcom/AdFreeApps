const CACHE_NAME = 'ad-free-apps-v10';
const urlsToCache = [
    '/',
    '/index.html',
    '/offline.html',
    ...
    '/metronome/style.css?v=3',
    '/metronome/metronome.js?v=3',
    '/timer/',
    '/timer/index.html',
    '/timer/timer.js?v=3',
    '/draw/',
    ...
    '/morse-code/style.css?v=3',
    '/morse-code/morse.js?v=3',
    '/tasker/',
    '/tasker/index.html',
    '/tasker/style.css?v=3',
    '/tasker/tasker.js?v=3',
    '/quizard/',
    '/quizard/index.html',
    ...
    '/times-tables/style.css?v=5',
    '/times-tables/times-tables.js?v=5',
